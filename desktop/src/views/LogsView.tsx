                ...
                <tr key={i} style={{ borderBottom: "1px solid var(--border-secondary, #1a1a2e)" }}>
                  ...
                  <td style={{ padding: "6px 10px", fontSize: 12 }}>
                    <span style={{
                      ...
                      background: success ? "#17255444" : "#7f1d1d44",
                      border: `1px solid ${success ? "#1d4ed8" : "#ef4444"}`,
                    }}>
                      {success ? "OK" : "FAIL"}
                    </span>
                  ...
                  <td style={{ padding: "6px 10px" }}>
                    <span style={{
                      ...
                      <span style={{
                        ...
                        background: (e.complexity_score ?? e.complexity) > 0.7 ? "#ef4444" : (e.complexity_score ?? e.complexity) > 0.4 ? "#eab308" : "#2563eb",
                      }} />
                    </span>
                  ...
                  <td style={{ padding: "6px 10px", color: e.has_tools ? "#2563eb" : "var(--text-muted, #64748b)", fontSize: 12 }}>
                    {e.has_tools ? "Yes" : "No"}
                  </td>
                  <td style={{ padding: "6px 10px", fontFamily: "monospace", fontSize: 12, color: "var(--text-muted, #64748b)" }}>
                    {e.msg_count}
